    ...
    public Result createInstantCheckout(
        ...
        if (kbAccountId == null || amount == null || currencyCode == null || kbPaymentId == null
            ...
            return Results.with(Status.BAD_REQUEST)
                    .type(MediaType.json)
                    .set("error", "Missing required parameters: kbAccountId, amount, currency, kbPaymentId, kbTransactionId, success_redirect_url");
               }
        ...
        try {
            ...
            return Results.with(Status.BAD_REQUEST)
                    .type(MediaType.json)
                    .set("error", "Invalid currency: " + currencyCode);
        }
