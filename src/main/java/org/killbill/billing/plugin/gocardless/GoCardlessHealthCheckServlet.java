...
@Singleton
@Path("/healthcheck")
public class GoCardlessHealthCheckServlet extends PluginHealthcheck {
	
    private final GoCardlessHealthCheck healthcheck;

    @Inject
    public GoCardlessHealthCheckServlet(final GoCardlessHealthCheck healthcheck) {
